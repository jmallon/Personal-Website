...
Any claim that cannot be falsified is a belief/emotive statement
  ...
  - or evidence does falsify the claim
      ...
      - e.g. pictures of the earth that depict it as a sphere are photoshopped (better example)
...
- Wakefield was paid by a source that was looking for damaging evidence against the manufacturers of a vaccine and is a 'conflict of interest'
- Methods are not replicable as qualitiative data are inconsistent
- Wakefield's claim is nonfalisifiable and not supported by any evidence
